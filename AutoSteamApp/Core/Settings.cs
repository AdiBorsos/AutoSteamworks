...
namespace AutoSteamApp.Core
{
    public static class Settings
    {
        ...
        public static string SupportedGameVersion = "421631"; // update 15.20.00
        ...
        public static ulong Off_DiffSlot = 0x26CC00; // start of each save slot data slotnr * off. update 15.20.00 it should be working ._.
        #endregion
